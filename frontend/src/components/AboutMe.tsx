...
export function AboutMe() {
    return (
        <section id="about" className="py-24 relative overflow-hidden">
            {/* Local AboutMe Gradient */}
            <div className="absolute inset-0 -z-10 bg-slate-50/20">
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[600px] bg-purple-100/30 rounded-full blur-[100px] opacity-60 mix-blend-multiply" />
                <div className="absolute bottom-0 right-0 w-[800px] h-[600px] bg-pink-100/30 rounded-full blur-[100px] opacity-60 mix-blend-multiply" />
            </div>
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
                    ...
                    <div className="lg:col-span-5 lg:sticky lg:top-24">
                        ...
                        >
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-50 text-indigo-600 text-sm font-bold mb-8 ring-1 ring-indigo-100">
                            ...
                            <h2 className="text-4xl font-medium tracking-tight text-slate-900 sm:text-5xl mb-2 font-display">
                                Josué Kenge
                            </h2>
                            <div className="text-xl font-medium text-indigo-600 mb-8 font-body">Founder & Full Stack Engineer</div>
                            ...
                            <div className="flex gap-4 justify-center lg:justify-start">
                                ...
                                <a
                                    ...
                                    className="px-6 py-3 rounded-xl bg-indigo-600 text-white font-medium shadow-lg shadow-indigo-600/20 hover:bg-indigo-700 hover:scale-[1.02] transition-all flex items-center gap-2 font-body"
                                >
                    ...
                    <div className="lg:col-span-7">
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            transition={{ duration: 0.6 }}
                            className="bg-white rounded-3xl p-8 lg:p-12 shadow-sm ring-1 ring-slate-200/60 relative overflow-hidden"
                        >
                            <div className="absolute top-0 right-0 -mt-20 -mr-20 w-80 h-80 bg-indigo-50 rounded-full blur-3xl -z-10"></div>

                            <div className="flex items-center gap-3 mb-8">
                                <div className="p-2 rounded-lg bg-purple-50 text-purple-600 border border-purple-100">
                                    <Briefcase className="h-6 w-6" />
                                </div>
                                <h3 className="text-2xl font-bold text-slate-900 font-display">My Story</h3>
                            </div>

                            <div className="prose prose-lg text-slate-600 space-y-8 leading-relaxed font-body">
                                <div>
                                    <h4 className="text-xl font-bold text-slate-900 mb-3 font-display">The Origin of Zerpha</h4>
                                    <p>
                                ...
                                <div>
                                    <h4 className="text-xl font-bold text-slate-900 mb-3 font-display">A Journey of Innovation</h4>
                                    <p>
                                ...
                                <div className="bg-indigo-50 rounded-2xl p-6 mt-8 border border-indigo-100">
                                    <p className="text-indigo-900 font-medium italic font-display">
