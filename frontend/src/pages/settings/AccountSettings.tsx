    ...
    return (
        <div className="space-y-6">
                ...
                <div className="flex items-start gap-6">
                    <div className="flex-shrink-0">
                        <div className="relative group cursor-pointer">
                            <div className="w-20 h-20 rounded-full bg-white/[0.06] flex items-center justify-center border-2 border-white/[0.06] overflow-hidden">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-2">
                                ...
                                <input
                                    ...
                                    className="w-full px-3 py-2 border border-white/[0.08] bg-white/[0.04] text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 placeholder:text-white/20"
                                />
                            </div>
                            <div className="space-y-2">
                                ...
                                <input
                                    ...
                                    className={`w-full px-3 py-2 border border-white/[0.08] rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 bg-white/[0.04] text-white placeholder:text-white/20 ${isGoogleUser ? 'bg-white/[0.03] text-white/30 cursor-not-allowed' : ''
                                        }`}
                                />
                            </div>
                        </div>
            ...
            >
                <div className="space-y-6">
                    {isGoogleUser && (
                        <div className="p-4 bg-indigo-400/10 border border-indigo-500/20 rounded-lg flex items-start gap-3">
                            <Shield className="w-5 h-5 text-indigo-400 mt-0.5" />
                            <div>
                                <h4 className="text-sm font-medium text-white">Account Secured by Google</h4>
                    ...
                    <div className={`flex items-center justify-between py-1 ${isGoogleUser ? 'opacity-50 pointer-events-none' : ''}`}>
                        ...
                        <button
                            ...
                            className="px-4 py-2 text-sm font-medium text-white/60 bg-white/[0.06] border border-white/[0.08] rounded-lg hover:bg-white/[0.1] disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            Change Password
                        </button>
                    </div>
                    ...
                    <div className={`flex items-center justify-between py-1 ${isGoogleUser ? 'opacity-50 pointer-events-none' : ''}`}>
                        ...
                        <button
                            ...
                            disabled={isGoogleUser}
                            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-[#09090b] ${twoFactorEnabled ? 'bg-indigo-600' : 'bg-white/[0.12]'
                                }`}
                        >
                            <span
